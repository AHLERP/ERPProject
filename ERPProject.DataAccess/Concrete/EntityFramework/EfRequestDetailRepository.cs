...
{
    public class EfRequestDetailRepository : EfRepository<RequestDetail>,IRequestDetailRepository
    {
        public EfRequestDetailRepository(DbContext dbContext) : base(dbContext)
        {
        }
    }
}
