...
namespace ERPProject.DataAccess.Concrete.EntityFramework.Context
{
    public partial class ERPContext : DbContext
    {
        ...
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-R04PVQ3\\SQLEXPRESS; Initial Catalog=ErpDB; Integrated Security=true; TrustServerCertificate=True");//Enes-Hakan
